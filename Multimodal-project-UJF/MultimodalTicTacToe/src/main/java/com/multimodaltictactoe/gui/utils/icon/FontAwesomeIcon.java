...
public enum FontAwesomeIcon {
    ...
    private static final Logger logger = Logs.getLogger(FontAwesomeIcon.class);
    
    static {
	Font fontAwesome = Font.loadFont(MultimodalTicTacToe.class.getResourceAsStream("FontAwesome.otf"), 15);
	if(fontAwesome == null) {
	    logger.severe("Chargement FontAwesome : ECHEC");
	}
	else {
	    logger.info("Chargement FontAwesome : REUSSI");
	}
    }
